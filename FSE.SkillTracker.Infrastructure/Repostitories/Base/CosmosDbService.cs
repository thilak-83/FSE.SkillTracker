using FSE.SkillTracker.Application.Interfaces.Base;
...
namespace FSE.SkillTracker.Infrastructure.Repostitories.Base
{
    public class CosmosDbService : CosmosDbObject, ICosmosDbService
    {
        ...
        {
            var LAccount = "https://localhost:8081";
            var LKey = "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==";
